...
{
    public partial class EditRackType : EditForm
    {
        ...
        public void InitializeVariable()
        {
            ...
            dataTabTmp.Columns.Add("TypeName");
            ...
            if (dataConn != null)
            {
                string sql="select * from RackType";
                GetDataInfo(sql);
                idMax = GetId("select max(Id) from RackType");
            }
        }
        ...
        private void GetDataInfo(string sql)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                tmpDr["Id"] = id;
                tmpDr["TypeName"] = da.Tables[0].Rows[i]["TypeName"].ToString();
        ...
        public void ShowDataInfo()
        {
            ...
            this.RackTypeGridView.Columns.Add("TypeName", "类型名称");
            ...
            for (int i = 0; i < dataTabTmp.Rows.Count; i++)
            {
                ...
                this.RackTypeGridView.Rows[i].Cells["TypeName"].Value =
                        dataTabTmp.Rows[i]["TypeName"].ToString();
        ...
        private void butAdd_Click(object sender, EventArgs e)
        {
            ...
            AddDataInfo(textTypeName.Text, ACTION.INSERT);
            textTypeName.Focus();
        }
        ...
        {
            UpdateDataBase();
            GetDataInfo("select * from RackType");
            ShowDataInfo();
        }
        ...
        private void UpdateDataBase()
        {
            ...
            for (int i = 0; i < RackTypeGridView.Rows.Count; i++)
            {
                ...
                if (act == "INSERT")
                {
                    str = "insert into RackType(TypeName) values(N'" + RackTypeGridView.Rows[i].Cells["TypeName"].Value.ToString() + "')";
                ...
                if (act == "UPDATE")
                {
                    str = "update RackType set TypeName=N'" + RackTypeGridView.Rows[i].Cells["TypeName"].Value.ToString() + "' where id=" + id;
                    count = dataConn.Update(str);
        ...
        private void OnCellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (Equal("TypeName", str, e.RowIndex))
                    {
        ...
        private void DeleteDataBase()
        {
            ...
            //删除数据库
            sql = "delete RackType where id=" + id;
